        ...
        <head>
            ...
            <body>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="page-header1">Suresh Raina</h2>
                        </div>
                    </div>
                    <div class="carousel-inner">
                        <div class="item active">
                          ...
                          <div class="carousel-caption">
                              ...
                              <h3><a href="http://www.espncricinfo.com/bangladesh/content/player/56007.html">International profile Â»</a></h3>
                              <div class="item-images">
                                <img class="images" src="raina.jpg" alt="">
                              </div>
                            </div>
